...
def find_input_device(name_fragment: str = DEVICE_NAME_FRAGMENT) -> tuple[int, dict]:
    ...
    if not matches:
        ...
        print("Run `python audio_pitch_detector.py --list-devices` to see available inputs.", file=sys.stderr)
        raise SystemExit(1)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default="artifacts/recording.wav", help="Output WAV path for --record")
