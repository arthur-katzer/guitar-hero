"""Operational audio pitch analysis for the sandbox.

This module owns the live-audio boundary for the sandbox use case. It keeps
device access and FFT pitch policy independent from Qt so the desktop view can
change without rewriting detector behavior.
"""
