#!/usr/bin/env python3
"""
minigame/cli/convert_songs.py
Extracts note-on events from all .mid files in data/songs/mid/ and writes
a rhythm-game chart to data/songs/json/ (only if the json doesn't exist).
